...
data_dir = [filesep filesep 'tier2' filesep 'card' filesep 'Data_pez3000'];
...
actStimTextA = struct('pos',{[.02 .66 .25 .23]},'str',{'Activation A'},'style',{'text'});
actStimTextB = struct('pos',{[.02 .36 .25 .23]},'str',{'Activation B'},'style',{'text'});
actStimTextC = struct('pos',{[.02 .06 .25 .23]},'str',{'Activation C'},'style',{'text'});
actStimPopA  = struct('pos',{[.14 .7 .15 .23]},'str',{photoStimOptions},'style',{'popupmenu'});
actStimPopB  = struct('pos',{[.14 .4 .15 .23]},'str',{photoStimOptions},'style',{'popupmenu'});
actStimPopC  = struct('pos',{[.14 .1 .15 .23]},'str',{photoStimOptions},'style',{'popupmenu'});
actDurationA = struct('pos',{[.51 .7 .25 .23]},'str',{'Duration: 0 ms'},'style',{'text'});
actDurationB = struct('pos',{[.51 .4 .25 .23]},'str',{'Duration: 0 ms'},'style',{'text'});
actDurationC = struct('pos',{[.51 .1 .25 .23]},'str',{'Duration: 0 ms'},'style',{'text'});
actLoadingA  = struct('pos',{[.3 .7 .09 .27]},'str',{'Load'},'style',{'pushbutton'});
actLoadingB  = struct('pos',{[.3 .4 .09 .27]},'str',{'Load'},'style',{'pushbutton'});
actLoadingC  = struct('pos',{[.3 .1 .09 .27]},'str',{'Load'},'style',{'pushbutton'});
actExecuteA  = struct('pos',{[.39 .7 .1 .27]},'str',{'Execute'},'style',{'pushbutton'});
actExecuteB  = struct('pos',{[.39 .4 .1 .27]},'str',{'Execute'},'style',{'pushbutton'});
actExecuteC  = struct('pos',{[.39 .1 .1 .27]},'str',{'Execute'},'style',{'pushbutton'});
actCouple    = struct('pos',{[.68 .8 .3 .23]},'str',{'Execute when camera triggers'},'style',{'checkbox'});
actDiscard   = struct('pos',{[.68 .58 .3 .23]},'str',{'Discard photodiode failures'},'style',{'checkbox'});
actCamDelayT = struct('pos',{[.68 .29 .25 .23]},'str',{'Camera delay (ms):'},'style',{'text'});
actCamDelayE = struct('pos',{[.9 .33 .08 .21]},'str',{'0'},'style',{'edit'});
actManualT   = struct('pos',{[.68 .04 .25 .23]},'str',{'Manual intensity (%):'},'style','text');
actManualE   = struct('pos',{[.9 .08 .08 .21]},'str',{'0'},'style',{'edit'});
...
for iterG = 1:ctrlCt
    hActivation.(hName{iterG}) = uicontrol(hSubPnl(5),'Style',hActivationOpts.(hName{iterG}).style,...
        ...
        'string',hActivationOpts.(hName{iterG}).str,'fontunits','normalized','position',...
...
posOp = {[.55 .1 .4 .7],[.1 .1 .9 .7],[.1 .1 .9 .7],[.1 .1 .9 .7],...
    ...
    [.55 .59 .3 .1],[.55 .49 .3 .1],[.67 .33 .27 .1],[.1 .675 .6 .1]};
...
posOp = {[.1 .1 .4 .8],[.2 .5 .1 .4],[.2 .1 .1 .4],[.2 .15 .6 .15],...
    ...
    [.74 .26 .2 .08],[.05 .15 .65 .1],[.27 .06 .17 .08],[.65 .7 .25 .1],...
...
posOp = {[.1 .51 .8 .4],[.1 .1 .8 .4],[.1 .55 .25 .35],[.1 .425 .8 .125],...
    ...
    [.05 .65 .4 .12],[.05 .53 .4 .12],[.1 .6 .4 .08],[.5 .6 .4 .08]};
...
btnCt = numel(btnNames);
posOps = {[.05 .65 .9 .3],[.05 .35 .9 .3],[.05 .05 .9 .3]};
...
visStimPop = uicontrol(hSubPnl(12),'style','popupmenu','units','normalized',...
    'position',[.05 .825 .9 .125],'string',visStimOptions,'fontunits','normalized','backgroundcolor',editC);
...
%% Photostimulation and Visual Stimulus Control
    function loadActivationCall(hObj,~)
        ...
        if strcmp(fileName,photoStimOptions{1})
            set(hDurOps(hLoadOps == hObj),'string',['Duration: ' num2str(0) ' ms'])
            return
        end
        ...
        if exist(varPath,'file')
            ...
            set(hDurOps(hLoadOps == hObj),'string',['Duration: ' num2str(varLoad.var_tot_dur) ' ms'])
        end
