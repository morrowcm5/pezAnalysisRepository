function [missedFrms,whiteCt] = presentGeneralStimulusUDP_multiLoop(stimTrigStruct)
%presentDiskStimulus Receives previously initialized variables in struct
%and quickly presents the visual stimulus

try
    
    whiteCt = stimTrigStruct.whiteCt*stimTrigStruct.numLoops;
    ...
    missedFrmLoop = zeros(1,stimTrigStruct.numLoops);
    for iterLoop = 1:stimTrigStruct.numLoops
        missedFrms(:) = 0;
        ...
        missedFrmLoop(iterLoop) = sum(missedFrms > 0);
    end
