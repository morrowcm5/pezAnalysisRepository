...
%             posCell = textscan(gatePosMCU,'%u%u','delimiter',',');
            set(hPezSlid.open,'Min',80,'Max',99,'Value',posOpen,'Sliderstep',[1/20 1/20]);
            set(hPezSlid.block,'Min',80,'Max',99,'Value',posBlock,'Sliderstep',[1/20 1/20]);
            hOpen1Callback([],[])
            gatePosMCU = [];
        end
