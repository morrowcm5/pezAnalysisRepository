function motion_array = graphTable_motionFromZeroFly(position_array,mm_per_pixel,sample_freq)
...
%   x,y,z which should be obtained from the graphTable along with
%   'flipBool'. 'sample_freq' (usually 6000) is the record rate and can
%   be loaded from the excel file.  If 'position_vector' is 1-by-n,
