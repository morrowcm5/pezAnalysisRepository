...
r = 0.01; %Object radius in m
d = .15; %Starting object distance in m
ellovervee = 40; %l/v of object in ms
theta = 45; %off-axis angle in degrees
...
x = ((r*(stimTimeVector(i))/ellovervee)*sin(theta));
y = (d - (r*(stimTimeVector(i))/ellovervee)*cos(theta))*cos(el);
z = d*sin(el) - (r*(stimTimeVector(i))/ellovervee)*sin(el)*sin(el);
...
%fileName = 'offaxisloom_t-40_el45_lv40_r0p025_d0p15';
